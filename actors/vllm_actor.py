...
logger.info("Actor %s started", os.getpid())
...
class VLLMActor:
    def __init__(self, args):
        ...
        # set up logging
        # self.log = setup_logger("actor", os.path.join(args.run_folder, "logs"), rank=os.getpid())
        # hijack_print(self.log); self.log.info("Actor started")
