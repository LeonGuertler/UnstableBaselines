...
if __name__ == "__main__":
    ...
    eval(run_name=args.run_name, config=args.config, adapter_checkpoint=args.adapter_checkpoint, adapter_revision=args.adapter_revision, opponent_model=args.opponent_model, opponent_adapter_checkpoint=args.opponent_adapter_checkpoint, env=args.env)