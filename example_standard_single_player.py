...
env_sampler = unstable.samplers.env_samplers.CurriculumEnvSampler(
    train_env_specs=[
        unstable.TrainEnvSpec(env_id="2048-v0-ultra-easy-train", num_players=1, num_actors=1, prompt_template="qwen3-sp"),
        unstable.TrainEnvSpec(env_id="2048-v0-mega-easy-train", num_players=1, num_actors=1, prompt_template="qwen3-sp"),
...
try:
    collector.collect.remote(num_train_workers=150, num_eval_workers=16)
