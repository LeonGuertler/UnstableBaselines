...
TRAINING_ENVS = [
    ...
    ("2048-v0-ultra-easy-train", 1, "qwen3-sp"),
    # ("2048-v0-mega-easy-train", 1, "qwen3-sp"),
    ...
    ("Blackjack-v0-train", 1, "qwen3-sp"),
    # ("Blackjack-v0-long-train", 1, "qwen3-sp"),
    ("WordLadder-v0-train", 1, "qwen3-sp"),
    # ("WordLadder-v0-medium-train", 1, "qwen3-sp"),
    ("Sudoku-v0-very-easy-train", 1, "qwen3-sp"),
    # ("Sudoku-v0-easy-train", 1, "qwen3-sp"),
    # ("Sudoku-v0-train", 1, "qwen3-sp"),
    ("TowerOfHanoi-v0-train", 1, "qwen3-sp"),
    # ("TowerOfHanoi-v0-medium-train", 1, "qwen3-sp"),
    ("WordSearch-v0-train", 1, "qwen3-sp"),
    # ("WordSearch-v0-hardcore-train", 1, "qwen3-sp"),
]
EVALUATION_ENVS = [
    ("FrozenLake-v0-random-train", 1, "qwen3-sp"),
    ("Wordle-v0-train", 1, "qwen3-sp"),
    ("GuessTheNumber-v0-train", 1, "qwen3-sp"),
    # ("Wordle-v0-train", 1, "qwen3-sp"),
    # ("Mastermind-v0-train", 1, "qwen3-sp"), # similar to wordle
    # ("Minesweeper-v0-small-train", 1, "qwen3-sp"),
    # ("Sokoban-v0-train", 1, "qwen3-sp"),
...
tracker = unstable.Tracker.options(name="Tracker").remote(run_name=f"sp-experiment2-{MODEL_NAME.split('/')[-1]}-{[t[0] for t in TRAINING_ENVS]}-{int(time.time())}", wandb_project="UnstableBaselines")
...
collector.collect.remote(num_workers=640, num_eval_workers=16)  
